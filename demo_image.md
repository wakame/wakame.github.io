...
You can access Wakame-vdc's WebUI by surfing to <a href="http://10.0.2.15:9000" target="_blank">http://10.0.2.15:9000</a> in a browser of your choice. Javascript needs to be enabled for the WebUI to function. Log into the WebUI with the following credentials.
...
If you have any more issues with Wakame-vdc, please feel free to ask us on the [Google Group](google_group.html) or in the [Public Chatroom](chatroom.html). We're always very busy developing so we might not have time to answer you right away but we will do our best to get back to you as soon as possible.
